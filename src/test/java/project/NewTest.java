...
public class NewTest extends Base 
{
	...
	public void multicity(String from1,String to1,String from2,String to2,String airline) throws Exception 
	{
		  ...
		  driver.findElement(By.xpath(p.getProperty("from1"))).clear();
		  driver.findElement(By.xpath(p.getProperty("from1"))).sendKeys(from1);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("from1"))).sendKeys(Keys.ARROW_DOWN);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("from1"))).sendKeys(Keys.ENTER);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to1"))).clear();
		  driver.findElement(By.xpath(p.getProperty("to1"))).sendKeys(to1);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to1"))).sendKeys(Keys.ARROW_DOWN);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to1"))).sendKeys(Keys.ENTER);
		  Thread.sleep(1000);
		  ...
		  driver.findElement(By.xpath(p.getProperty("from2"))).clear();
		  driver.findElement(By.xpath(p.getProperty("from2"))).sendKeys(from2);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("from2"))).sendKeys(Keys.ARROW_DOWN);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("from2"))).sendKeys(Keys.ENTER);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to2"))).clear();
		  driver.findElement(By.xpath(p.getProperty("to2"))).sendKeys(to2);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to2"))).sendKeys(Keys.ARROW_DOWN);
		  Thread.sleep(1000);
		  driver.findElement(By.xpath(p.getProperty("to2"))).sendKeys(Keys.ENTER);
		  Thread.sleep(1000);
		  driver.manage().deleteAllCookies();
